(function($) {    
    var slide = function(ele,options) {
        ...
        var states = [
            ...
            { $zIndex: 1, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 21 + '%', $opacity: 1 },//
            { $zIndex: 2, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 0,        $opacity: 1 },
            { $zIndex: 3, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 21 + '%', $opacity: 1 },
            { $zIndex: 4, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 43 + "%", $opacity: 1 },
            { $zIndex: 3, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 65 + '%', $opacity: 1 },
...
``
        ...
        function move() {
            $lis.each(function(index, element) {
                ...
                $(element).css('zIndex', state.$zIndex).finish().animate(state, setting.speed).find('img, h3, p').css('opacity', state.$opacity);
            });
        }
