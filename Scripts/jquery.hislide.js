(function($) {    
    var slide = function(ele,options) {
        ...
        var states = [
            ...
            { $zIndex: 1, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 23 + '%', $opacity: 0.1 },
            { $zIndex: 2, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 0,        $opacity: 1 },
            { $zIndex: 3, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 23 + '%', $opacity: 1 },
            ...
            { $zIndex: 1, width: 12 + 'vw', height: 15 + 'vw', top: 0, left: 70 + '%', $opacity: 0.1 }
        ];
